  ...
  return (
    <>
      <button
        ...
        aria-label="Record"
        className={`${positionClass} z-50 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-[#FF0759] to-[#FF8A90] drop-shadow-lg motion-safe:hover:scale-105 sm:hidden`}
      >
        +
      </button>
      <input
