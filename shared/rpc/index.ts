...
export const MethodDefinitions = {
  ...
  follow: z.tuple([z.string()]),
  unfollow: z.tuple([z.string()]),
  publish: z.tuple([z.any()]),
  searchPosts: z.tuple([z.string(), z.number().optional()]),
  topTags: z.tuple([TopTagsOpts]),
  saveBlob: z.tuple([FileSchema]),
  setMaxCacheMB: z.tuple([z.number()]),
...
export const MethodsSchema = z.union([
  ...
  z.object({ ns: z.literal('ssb'), fn: z.literal('follow'), args: MethodDefinitions.follow }),
  z.object({ ns: z.literal('ssb'), fn: z.literal('unfollow'), args: MethodDefinitions.unfollow }),
  ...
  z.object({ ns: z.literal('ssb'), fn: z.literal('saveBlob'), args: MethodDefinitions.saveBlob }),
  z.object({ ns: z.literal('ssb'), fn: z.literal('setMaxCacheMB'), args: MethodDefinitions.setMaxCacheMB }),
...
const methodArgSchemas: Record<MethodName, z.ZodTypeAny> = {
  ...
  follow: MethodDefinitions.follow,
  unfollow: MethodDefinitions.unfollow,
  publish: MethodDefinitions.publish,
  searchPosts: MethodDefinitions.searchPosts,
  topTags: MethodDefinitions.topTags,
  saveBlob: MethodDefinitions.saveBlob,
  setMaxCacheMB: MethodDefinitions.setMaxCacheMB,
